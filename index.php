      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
              ...
              <span class="icon-bar">meca1</span>
              <span class="icon-bar">meca2</span>
              <span class="icon-bar">meca3</span>
					  </button>
      ...
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(&quot;images/slider/<?php echo $slider03_imagen; ?>&quot;); height: 765px;">
          ...
          <div class="carousel-caption">
            <div>
			  <h2 class="heading animated bounceInDown"><?php echo $slider03_text03; ?></h2>
			  <p class="animated bounceInLeft"><?php echo $slider03_text04; ?></p>
              <!--
...
<br />
  ...
  <section id="programa" style="background-image: url(https://cdn.stocksnap.io/img-thumbs/960w/LHHL7FKKVD.jpg); background-size: 100%;">
    <div class="container">
  ...
  <section id="about-us">
    <div class="container">
      <div class="text-center">
        <div class="col-sm-8 col-sm-offset-2">
          <!--<h2 class="title-one">¿Funciones principales del Polideportivo?</h2>-->
      ...
      <div class="about-us">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <img src="./images/fachada.jpg" width="100%" />
      ...
      <div id="team-carousel" class="carousel slide" data-interval="false">
        ...
        <div class="carousel-inner team-members">
          ...
          <div class="row item active">
            <div class="col-sm-6 col-md-3">
              <div class="single-member">
                <img src="./images/enoch.jpg" alt="team member">
                <?php echo $dire_admon; ?>
                <p>admonplata@upp.edu.mx</p>
                <!--
									<div class="socials">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="single-member">
                <img src="./images/tres.jpg" alt="team member">
                <?php echo $comite_tellez; ?>
                <p>gaby_lopez@upp.edu.mx</p>
                <!--
									<div class="socials">
										<a href="#"><i class="fa fa-facebook"></i></a>
										<a href="#"><i class="fa fa-twitter"></i></a>
          ...
          <div class="row item">
            <div class="col-sm-6 col-md-3">
              <div class="single-member">
                <img src="./images/cuatro.jpg" alt="team member">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="single-member">
                <img src="./images/cinco.jpg" alt="team member">
...
<!-- Revistas -->
  ...
  <section id="registro" style="background-image: url(https://thumb1.shutterstock.com/display_pic_with_logo/1111658/353473379/stock-photo-check-list-and-marker-353473379.jpg); background-size: 100%;">
    <div class="container">

      <div class="jumbotron" >
        <h1>Registro Polideportivo Plata</h1>

        <p>Ven y Forma parte de este gran Desarrollo Deportivo.!!! Registrate Ahora</p>
        <br />
        <br />
        <br />
        <a class="btn btn-primary" href="http://www.upp.edu.mx/front/" role="button">Registro</a>
        <br />
        <br />
        ...
        <div class="row text-center clearfix">
          ...
          <div class="col-sm-6">
            ...
            <div class="contact-address">
              <!-- contact address -->
              <address><p><span>POLIDEPORTIVO PLATA </span>2017</p><strong><?php echo $sede_nombre; ?></strong><br />
                <small>( Blvd. Felipe Ángeles, Zona Plateada, Pachuca de Soto, Hgo. C.P. 42084. )</small></address>
              <div class="social-icons">
                <!-- icons -->
                <a href="https://www.facebook.com/Potros-UPP-FBA-345182112272786/"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com/UPPachuca"><i class="fa fa-twitter"></i></a>
              </div>
              <!-- icons -->
            </div>
            <!--contact address -->
          ...
          <div class="col-sm-6">
            ...
            <div class="contact-address">
              ...
              <p><span>admonplata@upp.edu.mx</span></p>
