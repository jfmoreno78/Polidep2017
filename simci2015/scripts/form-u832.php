...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U841"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaje:</b></td><td>' . htmlentities($_REQUEST["custom_U836"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Institución:</b></td><td>' . htmlentities($_REQUEST["custom_U847"],ENT_COMPAT,'UTF-8') . '</td></tr>';
